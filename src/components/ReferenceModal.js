  ...
  render() {
    return (
      <div
        ...
        id={`new${this.props.title}ReferenceModal`}
        tabIndex="-1"
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content text-dark">
            <form
              id={`new${this.props.title}ReferenceForm`}
            ...
            >
              ...
              <div className="modal-body pb-0">
                <div className="form-group row">
                  <label
                    htmlFor={`new-${this.props.title}-reference-fullName`}
                  ...
                  <div className="col-12 col-sm-6">
                    <input
                      ...
                      id={`new-${this.props.title}-reference-fullName`}
                      required="required"
                    />
                  </div>
                </div>
                ...
                <div className="form-group row">
                  <label
                    htmlFor={`new-${this.props.title}-reference-mobile`}
                    className="col-form-label col-12 col-sm-4 text-sm-right mr-2"
                  >
                    Mobile:
                  </label>
                  <div className="col-12 col-sm-6">
                    <input
                      type="text"
                      className="form-control"
                      id={`new-${this.props.title}-reference-mobile`}
                      required="required"
                    />
                  </div>
                </div>
                ...
                <div className="form-group row">
                  <label
                    htmlFor={`new-${this.props.title}-reference-company`}
                    className="col-form-label col-12 col-sm-4 text-sm-right mr-2"
                  >
                    Company:
                  </label>
                  <div className="col-12 col-sm-6">
                    <input
                      type="text"
                      className="form-control"
                      id={`new-${this.props.title}-reference-company`}
                      required="required"
                    />
                  </div>
                </div>
                ...
                <div className="form-group row">
                  <label
                    htmlFor={`new-${this.props.title}-reference-position`}
                    className="col-form-label col-12 col-sm-4 text-sm-right mr-2"
                  >
                    Position:
                  </label>
                  <div className="col-12 col-sm-6">
                    <input
                      type="text"
                      className="form-control"
                      id={`new-${this.props.title}-reference-position`}
                      required="required"
                    />
                  </div>
                </div>
